...
public class PosterModel {
    ...
    public static boolean RELEASE_MODE = true; // Only used for icon might be useless.
    public static String[] USER_NAMES = {"Uri Gorelik", "Vsevolod \"Seva\" Vodonenko", "Lucas Hudson", "Zac Henderson"};
    ...
    public static void main (String[] args) {
        ...
        // Prcesses with - Add to arive -- title args[0] --- article args[1] ---- number of paragraphs to use in index ----- author 
    ...
    private void createDocuments(ArrayList<String> listToAddTo, ArrayList<String> contentToAdd, String liveInception, String name)throws IOException {
        ...
        PrintWriter out = new PrintWriter(new FileWriter(Poster.SAVE_PATH + name));
    ...
    private void loadTemplate() {
        ...
        try {
            ...
            JOptionPane.showMessageDialog(null,
                    "Template not found cannot continue.",
                    "No Template", JOptionPane.ERROR_MESSAGE);
    ...
    // TODO Complete rework this method
        ...
        for (Iterator iterator = template.iterator(); iterator.hasNext();) {
            ...
            if (toArchive) {
                ...
                if (matcher.find()) {
                    ...
                    if (article.getParagraphs().get(0).length() < 170) {
                        theBlurb = removeParagraphTags(article.getParagraphs().get(0).trim()) + " " + removeParagraphTags(article.getParagraphs().get(1).trim());
                        theBlurb = theBlurb.substring(0, 235) + "...";
                    } else if (article.getParagraphs().get(0).length() > 245) {
                    ...
                    s = matcher.replaceAll(theBlurb);   // TODO Fix to support $ signs
                }
            }
...
//        }
     ...
     * @param stream : The stream opened by the URL
     * @param addTo : The collection to be added to
     * @throws IOException
     */
     ...
     * 
     * @param location : where the article is to be inserted (line number)
     * @param template : What the user entered
     * @param toAppend
     * @param numOfParagraphs
     */
    private void insertArticle(int location, ArrayList<String> template, ArrayList<String> toAppend, int numOfParagraphs) {
        ...
        } else {   // Adds a specified number of paragraphs (used for index and what not);
